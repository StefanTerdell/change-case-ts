 ...
 * ## Examples
 * 
 * @example Changing the case of a string literal
 * 
 * ```typescript
 * import { changeCase } from "@stefan/change-case-ts";
 * 
 ...
 * ```
 * 
 * @example Changing the case of the keys in an object
 * 
 * ```typescript
 * import { changeCase } from "@stefan/change-case-ts";
 * 
 ...
 * ```
 * 
 * @example Changing the case of array or tuple values
 * 
 * ```typescript
 * import { changeCase } from "@stefan/change-case-ts";
 * 
 ...
 * ```
 * 
 * @example Changing the keys of objects within an array
 * 
 * ```typescript
 ...
 * ```
 * 
 * @example Loading a dotenv-file and parsing with Zod
 * 
 * Setup:
 * 
 * ```bash
